...
export const RELEASE_NOTES: string[] = [
  ...
  "Edição de pedido pelo Histórico agora atualiza o mesmo registro (sem duplicar), apenas mudando a data.",
  "Passe o mouse sobre a versão para ver as notas desta release.",
];
