      ...
      <header className="border-b border-border bg-card">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 py-3 flex items-center justify-between gap-2 flex-wrap">
          ...
          <div className="flex gap-1.5 sm:gap-2 flex-wrap">
            ...
            <Link to="/admin/prices" className="px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm rounded-md border border-border hover:bg-muted">
              💲 Histórico de preços
            </Link>
            <Link to="/admin/audit" className="px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm rounded-md border border-border hover:bg-muted">
              📜 Auditoria
            </Link>
